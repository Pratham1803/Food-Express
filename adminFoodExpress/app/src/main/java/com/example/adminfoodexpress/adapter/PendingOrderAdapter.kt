...
import com.example.adminfoodexpress.databinding.PenidnigOrdersItemBinding
...
class PendingOrderAdapter(
    ...
    private val listOrderAccepted: MutableList<Boolean>
    ...
    inner class PendingOrderViewHolder(private val binding: PenidnigOrdersItemBinding) :
        ...
        fun bind(position: Int) {
            binding.apply {
                var isAccepted = listOrderAccepted[position]
